...
<div className="row mb-3">
  <div className="col-12">
    <div
      className="alert"
      style={{
        background: (selectedTeam1 && selectedTeam2)
          ? "rgba(40, 167, 69, 0.2)"
          : "rgba(255, 193, 7, 0.2)",
        border: `1px solid ${
          (selectedTeam1 && selectedTeam2)
    ...
    >
      ...
      <br />
      <div className="mt-2">
        Team 1: {selectedTeam1 ? `✅ ${selectedTeam1.name}` : "❌ Not selected"}
        <br />
        Team 2: {selectedTeam2 ? `✅ ${selectedTeam2.name}` : "❌ Not selected"}
        <br />
        Toss Section:{" "}
        {selectedTeam1 && selectedTeam2
          ? "✅ Should be visible"
          : "❌ Hidden (select both teams)"}
      </div>
    </div>
  </div>
</div>
