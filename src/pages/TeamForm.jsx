...
const TeamForm = () => {
  ...
  const fetchTeamAndPlayers = async () => {
    try {
      ...
      if (playersResponse.data.success) {
        console.log('Players data received:', playersResponse.data.players); // Debug log
  ...
  const openPlayerModal = (player = null) => {
    if (player) {
      // Editing existing player - handle both naming conventions
                    ...
                    {players.map((player) => (
                      <tr key={player.id || player._id}>
                        <td>
                          <img 
                            src={player.photo} 
                            alt={player.playerName || player.player_name || 'Player'} 
                            className="player-photo"
                            onError={(e) => {
                              const name = player.playerName || player.player_name || 'P';
                        ...
                        <td>
                          <div className="player-name">
                            {player.playerName || player.player_name || 'Unknown Player'}
                          </div>
                          {player.email && (
                        ...
                        <td>
                          ...
                          <button 
                            ...
                            onClick={() => handleDelete(player.id, player.playerName || player.player_name)}
                            title="Delete Player"
                            style={{ color: 'red' }}
                          >
